...
class Messenger
{
  ...
  public function start() {
	  echo "in messenger start \n\n";
	  flush();
	  $a=pn_messenger_start($this->impl);
	  echo "in messenger start after call to pn\n\n";
	  flush();
    $this->_check($a);
	  echo "in messenger start after call to check\n\n";
	  flush();
//    $this->_check(pn_messenger_start($this->impl));
  ...
  public function subscribe($source) {
    if ($source == null) {
	  ...
	  echo "in messenger subscribe \n\n";
	  flush();
	  $a= pn_messenger_subscribe($this->impl, $source);

	  echo "in messenger subscribe before call to check\n\n";
	  flush();
    $this->_check($a);
  }
